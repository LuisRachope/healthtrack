...
<body id="peso-editar">
	<div class="container-fluid editor" id="div-editar-peso">
		...
		<br>
			...
			<div class="form-group col-md-4">
				<label>Hora:</label>
				<input type="time" name="hora" class="form-control" placeholder="hh:mm" value="<javatime:format value="${alimentacao.hora }" style="-S"></javatime:format>" required>
			</div>
			<div class="form-group col-md-4">
				<label>Número de calorias:</label>
				<input type="text" name="cal" id="cal" maxlength="3" autocomplete="off" step="0.01" class="form-control" value="${alimentacao.calorias }" max="9999" required>
			</div>
	...
	<%@ include file="_modulos/foot-alimentacao.jsp" %>
</body>
</html>