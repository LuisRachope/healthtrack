...
<body id="peso-editar">
	<div class="container-fluid editor" id="div-editar-peso">
		...
		<form class="container-fluid form-vertical" id="form-edit-peso" method="post" action="Peso?acao=update">
			...
			<div class="form-group col-md-12">
				...
				<input type="text" name="peso" id="PesoAtual" step="0.01" min="5" maxlength="4" autocomplete="off" class="form-control" value="${peso.peso }" required="required">
			</div>
	...
	<%@ include file="_modulos/foot-peso.jsp" %>
</body>
</html>