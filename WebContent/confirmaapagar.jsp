...
<body id="peso-editar">
	...
	<a class="btn-danger btn-lg col-lg-4 text-center" href="javascript:window.history.go(-1)" id="universal">Não</a>
	<a class="btn-danger btn-lg col-lg-4 pull-right text-center" href="${link }" id="universal">Sim</a>
	</div>
