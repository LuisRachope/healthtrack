        ...
        <div style="background-color: white; margin: 15px 0px 15px 0px;" class="container-fluid">
            ...
            <div id="row2" class="container-fluid col-md-6">
                ...
                <div class="form-group" id="dados">
                    ...
                    <p class="col-md-6"><img src="_images/pressao-list.png"style="width: 45px;height: 35px;margin-left: 3px;margin-right: 17px;"> ${pressao.pressSistolica}/${pressao.pressDiastolica}mmHg</p>
                    <p class="col-md-12" style="text-align: center;width: 435px;font-weight: bold;">IMC</p>
                    <p class="col-md-6"><img src="_images/altura.PNG" class="img-circle">Altura: ${user.altura }m</p>
                    <p class="col-md-6"><img src="_images/peso.png" style="width: 50px;height: 34px;margin-left: 0px;margin-right: 20px;"> ${peso.peso }kg</p>
                    <c:set var="imc" scope="session" value="${peso.peso/(user.altura*user.altura) }" ></c:set>
                    <p class="col-md-12">
                    	<img src="_images/imc.jpg" class="img-circle" style="margin-right: 6px;">
            ...
            <div class="container-fluid col-md-6 pull-right" id="table-dashboard">
                ...
                <table class="table-striped table-responsive container-fluid" id="dashboard">
                    <tbody id="tcorpo">
                    <tr>
                        <td rowspan="2"><img src="_images/peso.png" class="img-circle" style="width: 46px;height: 32px;"></td>
                ...
                <table class="table-striped table-responsive container-fluid" id="dashboard">
                    <tbody id="tcorpo">
                    <tr>
                        <td rowspan="4"><img src="_images/pressao-list.png" class="img-circle" style="width: 45px;height: 35px;margin-right: 7px;margin-left: 13px;"></td>
                ...
                <table class="table-striped table-responsive container-fluid" id="dashboard">
                    <tbody id="tcorpo">
                    <tr>
                        <td rowspan="4"><img src="_images/ativ_fisica.png" class="img-circle" style="width: 45px;"></td>
                ...
                <table class="table-striped table-responsive container-fluid" id="dashboard">
                    <tbody id="tcorpo">
                    <tr>
                        <td rowspan="4"><img src="_images/comida.png" class="img-circle" style="width: 45px;"></td>
...
<%@ include file="_modulos/foot-main.jsp" %>
