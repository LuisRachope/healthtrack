            ...
            <section class="container-fluid" id="perfil-dados">
                ...
                <div class="form-group inline-form">
                    ...
                    <button type="button" class="btn-danger col-md-2" id="alterasenha" data-toggle="modal"
                            data-target="#modal-alterarsenha" id="botaomodalalterarsenha" style="top: 7px;">Alterar
                    </button>
                </div>
            </section>
        </div>
                    ...
                    <div class="modal-body">
                        <form class="container-fluid form-vertical" id="modificarperfil" method="post" action="MeuPerfil?acao=AlterarPerfil">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="${user.nome }" required="required" autofocus="autofocus">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="sobrenome">Sobrenome:</label>
                                <input type="text" name="sobrenome" id="sobrenome" class="form-control" value="${user.sobrenome }" required="required">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="dataNasc">Data de Nascimento:</label>
                                <input type="text" id="dataNasc" name="dataNasc" class="form-control data" value="<javatime:format value="${user.dtNasc }" pattern="dd/MM/yyyy"></javatime:format>" required="required">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="altura">Altura:</label>
                                <input type="text" id="altura" name="altura" step="0.01" min="0" max="99" maxlength="4" autocomplete="off" class="form-control" value="${user.altura }" min=0 required="required">
                            </div>
                            <div class="form-group col-md-12">
                                <label>Gênero:</label>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="confemail" type="email" id="confemail" name="confemail" class="form-control" value="${user.email }" required="required">
                            </div>
...
<%@ include file="_modulos/foot-perfil.jsp" %>
</body>
</html>