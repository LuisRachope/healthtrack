    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Nova Atividade Física</h4>
            </div>
            <div class="modal-body">
                <form class="container-fluid form-vertical" id="form-add-ativfisica" method="post" action="AtividadeFisica?acao=insert">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="cal" id="cal" maxlength="3" autocomplete="off" placeholder="350 kcal" step="0.01" class="form-control" required="required">
                    </div>
                    <div class="form-group col-md-4">
                        <label>Hora:</label>
                        <input type="time" name="hora" class="form-control" placeholder="hh:mm" required>
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        <div class="radio" id="sexo">
                            <div class="radio" id="tipo_ativfisica">
                                ...
                                <label class="radio-inline"><input type="radio" name="addativfisica" value="3">Musculação</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label>Descrição:</label>
                        <input type="text" name="descricao" class="form-control"  placeholder="Informe o motivo ou um ponto de referência da atividade realizada" >
                    </div>
