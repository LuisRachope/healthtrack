            ...
            <div class="modal-body">
                <form class="container-fluid form-vertical" id="form-add-alimentacao" method="post" action="Alimentacao?acao=insert">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="cal" id="cal" maxlength="4" autocomplete="off" placeholder="350 kcal" step="0.01" class="form-control" max="9999" required="required">
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="descricao" class="form-control" placeholder="Informe o(s) iten(s) que você consumiu">
                    </div>
