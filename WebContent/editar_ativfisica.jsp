...
<body id="peso-editar">
	...
	<div class="modal-body">
		<form class="container-fluid form-vertical" id="form-edit-ativfisica" method="post" action="AtividadeFisica?acao=update">
			...
			<div class="form-group col-md-4">
				...
				<input type="number" id="cal" name="cal" maxlength="3" autocomplete="off" step="0.01" class="form-control" value="${atividade.calorias }" required="required">
			</div>
			<div class="form-group col-md-4">
				<label>Hora:</label>
				<input type="time" name="hora" class="form-control" placeholder="hh:mm" value="<javatime:format value="${atividade.hora }" style="-S"></javatime:format>" required="required">
			</div>
	...
	<%@ include file="_modulos/foot-atividadefisica.jsp" %>
</body>
</html>